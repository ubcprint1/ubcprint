...
export default async function Page() {
  const products = await getActiveProducts('promo')

  return (
    <div className="min-h-screen bg-slate-50" dir="rtl">
      <WebsiteHeader />
      <StorefrontHero title="قسم المنتجات الترويجية" description="هدايا دعائية ومنتجات تسويقية مخصصة للشركات والفعاليات." active="promo" />
